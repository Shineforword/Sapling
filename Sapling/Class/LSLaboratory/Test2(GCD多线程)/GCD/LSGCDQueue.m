...
static LSGCDQueue * mainQueue;
static LSGCDQueue * globalQueue;
static LSGCDQueue * highPriorityGlobalQueue;
static LSGCDQueue * lowPriorityGlobalQueue;
static LSGCDQueue * backgroundPriorityGlobalQueue;

@interface LSGCDQueue ()

@property (nonatomic, strong, readwrite)dispatch_queue_t  dispatchQueue;

@end
@implementation LSGCDQueue
...
+ (void)initialize {
     ...
     */
    if (self == [LSGCDQueue self])  {
        
        mainQueue                     = [LSGCDQueue new];
        globalQueue                   = [LSGCDQueue new];
        highPriorityGlobalQueue       = [LSGCDQueue new];
        lowPriorityGlobalQueue        = [LSGCDQueue new];
        backgroundPriorityGlobalQueue = [LSGCDQueue new];
