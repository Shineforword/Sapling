...
extern const CGFloat  LSShowZoneCellContentLabelFontSize;
extern CGFloat  LSMaxContentLabelHeight;

@implementation LSShowZoneModel
{
...
- (NSString *)contentStr
{
    ...
    if (contentW != _lastContentWidth) {
        ...
        CGRect textRect = [_contentStr boundingRectWithSize:CGSizeMake(contentW, MAXFLOAT)
                                                 ...
                                                 attributes:@{NSFontAttributeName : [UIFont systemFontOfSize:LSShowZoneCellContentLabelFontSize]}
                                                    context:nil];
        /** extern修饰的内容:源码全局变量?*/
