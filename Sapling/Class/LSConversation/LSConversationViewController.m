...
@interface LSConversationViewController () <UITableViewDelegate,
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (!cell) {
        cell = [[LSMessageCell alloc] initWithStyle:UITableViewCellStyleSubtitle
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (checkStrRange.location != NSNotFound) {
        ...
        LSChatViewController *chatVc = [[LSChatViewController alloc] init];
