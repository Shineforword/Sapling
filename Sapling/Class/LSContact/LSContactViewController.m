...
@interface LSContactViewController ()<UITableViewDataSource,UITableViewDelegate>
...
- (void)apiRequestContactList{
    ...
    LSContactListRequest *request = [[LSContactListRequest alloc] initWithRUrl:Host_Server
...
- (void)setUpNav{
    ...
    [sureButton setTitleColor:BASE_GREEN_COLOR forState:UIControlStateNormal];
...
- (UITableViewCell *)tableView:(UITableView *)tableView
    ...
    static NSString *ident = @"LSMessageCell";
    LSMessageCell *cell = [tableView dequeueReusableCellWithIdentifier:ident];
    if (!cell) {
        
        cell = [[LSMessageCell alloc] initWithStyle:UITableViewCellStyleDefault
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    MySortingModel * model = _listDatas[indexPath.section][indexPath.row];
    LSDetailMessageViewController * detail = [[LSDetailMessageViewController alloc]init];
...
- (void)headerViewButtonClicked{
    ...
    LSNoticeViewController * noti = [[LSNoticeViewController alloc] init];
...
- (void)rightButtonClicked{
    LSAddFriendViewController * af = [[LSAddFriendViewController alloc] init];
